...
Never copy/paste a link into an email again. Just click our bookmarklet and choose who you want to send the link to. 

h3. Automatic User Creation

If you send somebody a link, we create an account for them automatically. Soon we will begin to use these so that a user who received an email  can login and start sending links right away, no registration required. 
